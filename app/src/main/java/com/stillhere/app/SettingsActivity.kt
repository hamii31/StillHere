...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun loadSettings() {
        ...
        binding.crisisLineField.setText(prefs.getString("crisis_line_number", "080032123"))
    ...
    private fun saveSettings() {
        val crisisLine = binding.crisisLineField.text.toString().trim()
            .ifEmpty { "080032123" }
        ...
        prefs.edit()
            ...
            .putString("crisis_line_number", crisisLine)
